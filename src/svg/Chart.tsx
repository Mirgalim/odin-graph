...
const Chart = ({ filter, selectedLevel, onLevelChange, data }: Props) => {
  ...
  //    }
  // }
  const [selectedTextDetails, setSelectedTextDetails] = useState<string | null>(
    null
  );
  const [clickedTextId, setClickedTextId] = useState<string | null>(null);
  ...
  const getCircleRadius = (lvl: Level): number | undefined => {
    if (!selectedLevel) {
        ...
        for (const [levelKey, level] of placement) {
          for (
            ...
            for (let lineIndex = 0; lineIndex < groupText.length; lineIndex++) {
              ...
              const { text, filterable, expandedY, expandedX, ...rest } =
                textLine;
              let fill = "#000";
              ...
              const textId = `${sectionKey}-${placementKey}-${levelKey}-${textGroupIndex}-${lineIndex}`;
              ...
              if (selectedLevel) {
                props.transform = `translate(${expandedX ?? 0} ${
                  expandedY ?? 0
                })`;
                props.fontSize = 11;
              }
  ...
  return (
    ...
    >
      ...
      >
        ...
        <g>
          {!selectedLevel && (
            <text
              x="937"
              y="962"
              transform={getLevelLabelTransform(5)}
              fontSize={20}
              fontWeight={600}
            >
              V
          ...
          {!selectedLevel && (
            <text
              ...
              fontSize={20}
              fontWeight={600}
              transform={getLevelLabelTransform(4)}
            >
              IV
            </text>
          )}
          {!selectedLevel && (
            <text
              ...
              fontSize={20}
              fontWeight={600}
              transform={getLevelLabelTransform(3)}
            >
              III
            </text>
          )}
          {!selectedLevel && (
            <text
              ...
              fontSize={20}
              fontWeight={600}
              transform={getLevelLabelTransform(2)}
            >
              II
            </text>
          )}
          {!selectedLevel && (
            <text
              ...
              fontSize={20}
              fontWeight={600}
              transform={getLevelLabelTransform(1)}
            >
              I
            </text>
          )}
        ...
        <text
          transform="translate(620, 410) rotate(-45)"
          fontSize={25}
          fontWeight={900}
        >
          State
        ...
        <text
          transform="translate(370, 660) rotate(-45)"
          fontSize={25}
          fontWeight={900}
        >
          Social
        ...
        <text
          transform="translate(910, 360) rotate(45)"
          fontSize={25}
          fontWeight={900}
        >
          Private
        ...
        <text
          transform="translate(1160, 610) rotate(45)"
          fontSize={25}
          fontWeight={900}
        >
          Internal
        ...
        <text
          transform="translate(340, 910) rotate(45)"
          fontSize={25}
          fontWeight={900}
        >
          Education
        ...
        <text
          transform="translate(580, 1150) rotate(45)"
          fontSize={25}
          fontWeight={900}
        >
          Government
        ...
        <text
          transform="translate(920, 1230) rotate(-45)"
          fontSize={25}
          fontWeight={900}
        >
          Social
        ...
        <text
          transform="translate(1170, 980) rotate(-45)"
          fontSize={25}
          fontWeight={900}
        >
          External
      ...
      <div>
        ...
        {selectedTextDetails ? (
          <ul style={{ listStyleType: "none", paddingLeft: "0" }}>
            {selectedTextDetails.split(",").map((detail, index) => (
              <li
                key={index}
                style={{
                  padding: "10px",
